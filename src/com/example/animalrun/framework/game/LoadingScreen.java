...
public class LoadingScreen extends Screen {
	...
	public void update(float deltaTime) {
		...
		Assets.ScoreScreen_retry = g.newPixmap("ScoreScreen_retry.png", PixmapFormat.ARGB4444);
		Assets.ScoreScreen_title = g.newPixmap("ScoreScreen_title.png", PixmapFormat.ARGB4444);
